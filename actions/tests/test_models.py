...
class ActionsModelTest(TestCase):
    def test_field_content(self):
        action = Actions.objects.create(name="Test Action", description="Test Description", prompt="Test Prompt")
...
class PromptsModelTest(TestCase):
    def test_field_content(self):
        action = Actions.objects.create(name="Test Action", description="Test Description", prompt="Test Prompt")
        prompt = Prompts.objects.create(name="Test Prompt", description="Prompt Description", action=action)
...
class ModelRelationshipTest(TestCase):
    def test_prompts_in_actions(self):
        action = Actions.objects.create(name="Action", description="Action Description", prompt="Action Prompt")
        Prompts.objects.create(name="Prompt 1", description="Description 1", action=action)
        Prompts.objects.create(name="Prompt 2", description="Description 2", action=action)
